            ...
            <div class="main-top">
                ...
                <div class="main-skills">
                    <div class="card">
                        ...
                        <h3>PRINCIPLES OF <br> MANAGEMENT</h3>
                        <p>Faculty: </p>
                        <br>
                    ...
                    <div class="card">
                        ...
                        <h3>DATA SECURITY <br> AND CRYPTOGRAPHY</h3>
                        <p>faculty: </p><br>
                    ...
                    <div class="card">
                        ...
                        <h3>COMPUTER GRAPHICS <br>AND VISUAL COMPUTING</h3>
                        <p>Faculty: </P><br>
                        <button>Get Started</button> 
                    </div>
                    <div class="card">
                        
                        <h3>PROFESSIONAL ELECTTIVE <br>II</h3>
                        <p>Faculty: </p><br>
                        <button>Get Started</button> 
                    </div>
                    ...
                    <div class="card">
                        ...
                        <p>Faculty: AJEESH KUMAR</p><br>
                        <button>Get Started</button> 
                    </div>
                    <div class="card">
                       
                        <h3>SOFT SKILL DEVELOPMENT</h3>
                        <p>Faculty: VANAJA V</p><BR>
                        <button>Get Started</button> 
                    </div>
                </div>
        </section>
