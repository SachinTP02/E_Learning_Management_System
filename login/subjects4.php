            ...
            <div class="main-top">
                ...
                <div class="main-skills">
                    <div class="card">
                        ...
                        <h3>COMPLEX VARIABLES & <br> PARTIAL DIFERENTIAL EQUATIONS</h3>
                        <p>Faculty: Rajendra Prasadh</p>
                        <br>
                    ...
                    <div class="card">
                        ...
                        <p>Faculty: Sreelakshmy H</P><br>
                        <button>Get Started</button> 
                    </div>
                    <div class="card">
                        
                        <h3>SOFTWARE <br> ENGINEERING</h3>
                        <p>Faculty: Jabir K V</p><br>
                        <button>Get Started</button> 
                    </div>
                    ...
                    <div class="card">
                        ...
                        <p>Faculty: Vineeth M V</p><br>
                        <button>Get Started</button> 
                    </div>
                    <div class="card">
                       
                        <h3>OBJECT ORIENTED <br> PROGRAMMING IN C++</h3>
                        <p>Faculty: HariKrishnan</p><BR>
                        <button>Get Started</button> 
                    </div>
                </div>
        </section>
