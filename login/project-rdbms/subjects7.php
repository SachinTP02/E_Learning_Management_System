            ...
            <div class="main-top">
                ...
                <div class="main-skills">
                    ...
                    <div class="card">
                        ...
                        <h3>DATA SECURITY & CRYPTOGRAPHY</h3>
                        <p><br>Faculty: </p><br>
                    ...
                    <div class="card">
                        ...
                        <h3>COMPUTER GRAPHICS & VISUAL COMPUTING</h3>
                        <p><br>Faculty: </P><br>
                        <button>Get Started</button> 
                    </div>
                    <div class="card">
                        
                        <h3>PROFESSIONAL <br>ELECTTIVE [II]</h3>
                        <p><br>Faculty: </p><br>
                        <button>Get Started</button> 
                    </div>
                    ...
                    <div class="card">
                        ...
                        <h3>OPEN <br>ELECTIVE [I]</h3>
                        <p><br>Faculty: </p><br>
                        <button>Get Started</button> 
                    </div>
                    <div class="card">
                       
                        <h3>COMPUTER GRAPHICS LABORATORY</h3>
                        <p><br>Faculty: </p><BR>
                        <button>Get Started</button> 
                    </div>
                </div>
