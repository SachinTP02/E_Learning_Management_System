<?php
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['demail'] && $_SESSION['key']=='admin') 
    {
      ...
      header("location:dashboard2.php?q=1");
    }
  }
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='admin') 
    {
      ...
      header("location:dashboard2.php?q=5");
    }
  }
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='admin') 
    {
      ...
      header("location:dashboard2.php?q=4&step=2&eid=$id&n=$total");
    }
  }
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addqns' && $_SESSION['key']=='admin') 
    {
      ...
      header("location:dashboard2.php?q=0");
    }
  }
