...
<div class="container mt-2">
  ...
  <div class="row">
    ...
    <a href="notes_m1.php"><img src="https://static.pexels.com/photos/7096/people-woman-coffee-meeting.jpg" alt="Notes"></a>
        <h5 class="card-title  mt-3 mb-3">NOTES</h5>
        <p class="card-text">Notes uploaded by your teachers </p>
    ...
    <div class="col-md-3 col-sm-6 item">
      <div class="card item-card card-block">
      <h4 class="item-card-title text-right"><i class="material-icons">settings</i></h4>
    <a href="index.php"><img src="https://static.pexels.com/photos/7357/startup-photos.jpg" alt="Quiz"></a>
        <h5 class="card-title  mt-3 mb-3">QUIZ</h5>
        <p class="card-text">Enhance your learning by attending frequent quiz programs </p>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-right-circle" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.854 10.803a.5.5 0 1 1-.708-.707L9.243 6H6.475a.5.5 0 1 1 0-1h3.975a.5.5 0 0 1 .5.5v3.975a.5.5 0 1 1-1 0V6.707l-4.096 4.096z"/>
        </svg>
  </div>
    ...
    <div class="col-md-3 col-sm-6 item">
      <div class="card item-card card-block">
      <h4 class="item-card-title text-right"><i class="material-icons">settings</i></h4>
        <a href="dashboard.php"><img src="Wbhlogo.jpg" alt="Home Screen"></a>
        <h5 class="card-title  mt-3 mb-3">HOME</h5>
        <p class="card-text">Want to go back to home screen? </p>
