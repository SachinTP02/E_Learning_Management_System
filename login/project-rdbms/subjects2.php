            ...
            <div class="main-top">
                ...
                <div class="main-skills">
                    <div class="card">
                        ...
                        <p><br>Faculty: HariKrishnan</p>
                        <br>
                        <form action="semester.php"><button>Get Started</button> </form>
                    </div>
                    <div class="card">
                        
                        <h3>ENGINEERING <br> CHEMISTRY</h3>
                        <p><br>Faculty: </p><br>
                    ...
                    <div class="card">
                        ...
                        <h3>ENVIRONMENTAL <br> STUDIES</h3>
                        <p><br>Faculty: Chandhni Mariam Chacko</p><BR>
                        <button>Get Started</button> 
                    </div>
                </div>
        </section>
