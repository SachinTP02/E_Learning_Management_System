...
<body>
    ...
    <nav class="navbar navbar-default title1">
        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>> <a href="dashboard.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home</a></li>
            <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a href="welcome.php?q=1"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Topics<span class="sr-only">(current)</span></a></li>
