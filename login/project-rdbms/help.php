...
<body>
  ...
  <div class="profile-card js-profile-card">
    ...
    <div class="profile-card__cnt js-profile-cnt">
      ...
      <div class="container">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i class='far fa-hand-point-right' style='font-size:50px'></i>
  <div class="arrow">
    <div class="outer"></div>
    <div class="inner"></div>
  </div>
  <div class="message-body">
  <div class="profile-card__txt"><br><?php echo "Welcome, ". $_SESSION['email'] . " ! "?><br><br>Facing Some Issues?  <br> Contact Us</div><br>
  </div>
</div>
      ...
      <div class="profile-card-social">
        ...
        <a href="https://twitter.com/SACHIN__TP" class="profile-card-social__item twitter" target="_blank">
          <span class="icon-font">
        ...
        <a href="https://github.com/SachinTP02" class="profile-card-social__item github" target="_blank">
          <span class="icon-font">
